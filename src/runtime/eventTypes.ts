...
/**
 * The type of valtio-kit's `on` function. This is public in case you'd like to
 * use it for your own utility functions that attach event listeners in a
 * type-safe manner.
 *
 * Its type parameter gives you control over the return type.
 */
export interface AddEventListener<TResult> {
